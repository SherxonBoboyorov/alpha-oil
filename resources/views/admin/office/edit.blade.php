        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="page-title-box">
                    <h4 class="page-title">Edit Warehouses</h4>
                </div>
            </div>
                    ...
                    <div class="row" style="margin-top: 15px">
                        ...
                        <div class="row" style="margin-top: 15px">
                            <div class="col-md-3">
                                ...
                                <input type="text" id="phone" value="{{ $office->phone }}" class="form-control" name="phone">
                                @if($errors->has('phone'))
                                <div class="alert alert-success alert-dismissible fade show" role="alert">
                                    <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                                        <span aria-hidden="true">&times;</span>
                        ...
                        <div class="row" style="margin-top: 15px">
                            <div class="col-md-8">
                                ...
                                <input type="text" id="address_uz" value="{{ $office->address_uz }}" class="form-control" name="address_uz">
                        ...
                        <div class="row" style="margin-top: 15px">
                            <div class="col-md-8">
                                ...
                                <input type="text" id="address_ru" value="{{ $office->address_ru }}" class="form-control" name="address_ru">
                        ...
                        <div class="row" style="margin-top: 15px">
                            <div class="col-md-8">
                                ...
                                <input type="text" id="address_en" value="{{ $office->address_en }}" class="form-control" name="address_en">
